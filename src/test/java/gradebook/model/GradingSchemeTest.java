...
/**
 * tests the grading scheme class for the gradebook
 * project
 * @author Rex
 *
 */
public class GradingSchemeTest {
	...
	public void testPrereqs(){
		...
		assertTrue(megaString.toString().equals(
		"Objects and DesignData Structures and AlgorithmsMATLABIntro to Object Oriented Programming"));
	}
